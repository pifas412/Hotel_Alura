...
public class Busqueda extends JFrame {
	...
	private ReservasControlador reservaControl;
	...
	public Busqueda() {
		...
		this.reservaControl = new ReservasControlador();
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >= 0) {
					...
					int confirmar = JOptionPane.showConfirmDialog(null, "Desea borrar al huesped");
					...
					JOptionPane.showMessageDialog(null, "Hubo un error al eliminar huesped");
				}
			}
		});
	...
	private void ActualizarReservas() {
		...
		.ifPresent(fila ->{
			...
			String valor = "P/" + calcularValorReserva(dataE, dataS);
			String formaPago = (String) modelo.getValueAt(tbReservas.getSelectedRow(), 4);
			Integer id = Integer.valueOf(modelo.getValueAt(tbReservas.getSelectedRow(), 0).toString());
			//para no cambiar los ID
	...
	private List<Huespedes> mostrarHuespedes(){
		return this.huespedControl.mostrarHuesppedes();
	}
	
	private List<Huespedes> buscarHuespedesId(){
		return this.huespedControl.buscarHuesppedes(txtBuscar.getText());
	}
	...
	private void actualizarHuespedes() {
		...
		.ifPresentOrElse(filaHuespedes ->{
			...
			if(tbHuespedes.getSelectedColumn() == 0 || tbHuespedes.getSelectedColumn() == 6) {
				JOptionPane.showMessageDialog(this, "No se pueden modiificar los ID");
			}else {
				this.huespedControl.actualizar(nombre, apellido, null, nacionalidad, telefono, id_reserva, id_reserva);
				JOptionPane.showMessageDialog(this, String.format("Registro modificado con exito"));
			}
			
		}, () -> JOptionPane.showMessageDialog(this, "Por favor no cometas errores"));
	}
