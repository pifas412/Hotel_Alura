...
//Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
	...
	private void guardarReserva() {
		if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("")
			...
			Reservas reserva = new Reservas(dataE, dataE, txtValor.getText(), txtFormaPago.getSelectedItem().toString());
			...
			JOptionPane.showMessageDialog(this, "Debes llenar todod los campos");
		}
	}
	...
	public void calcularValor(JDateChooser dataE, JDateChooser dataS) {
		if(dataE.getDate() != null && dataS.getDate() != null) {
			...
			int dias = -1; //para que inicie en el dia siguiente
			int noche = 350; //valor por noche
			int valor;
	...
	//esto es para cuando actualizas la tabla, se limpia el valor
